...
from app.api import auth, chat, event, geo, health, news, sov, visualbranding, visuals, workflows, reports
...
def create_app() -> FastAPI:
    ...
    # --- Middleware ---
    configured_origins = [o.strip() for o in settings.BACKEND_CORS_ORIGINS.split(",") if o.strip()]
    app.add_middleware(
        CORSMiddleware,
